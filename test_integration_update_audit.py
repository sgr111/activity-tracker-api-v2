...
This was previously verified manually via Swagger UI before being automated 
here. Split into its own file to keep the AI tests focused on AI behavior 
(test_integration_ai.py) and the update/audit tests focused on update/audit 
behavior.
